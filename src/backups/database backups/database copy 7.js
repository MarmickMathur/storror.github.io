    ...
    function updatingdata(element, visiblity) {
      ...
      <div class="m-3">
          ...
          <form action="" id="${ele.name}getmenu"
                class="getmenu rounded-b-md border-t-2 border-white overflow-hidden cursor-default p-5 h-full">
                <div class="flex flex-row items-center w-full">
                <input id = "itemname" type="text" name="itemname" class="w-1/2 mr-5 bg-transparent rounded-md border-2 border-white h-12" required>
                <div class=" w-1/2">
                ...
                <button type="submit" class="bg-gray-600 mt-5">add</button>
          </form>
          </div>
          </div>  
      </div>
