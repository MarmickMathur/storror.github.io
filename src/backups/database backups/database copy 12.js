    ...
    function updatingdata(element, visiblity) {
      ...
      <div class="m-3">
          ...
          <form action="" id="${ele.name}getmenu"
                ...
                <input id = "itemname" type="text" name="itemname" class="w-1/2 mr-5 bg-transparent rounded-md border-2 border-white h-12 text-white font-headingside2" placeholder="add items to menu"  required autocomplete="off">
      ...
      for (const key in element.data()) {
        if (Object.hasOwnProperty.call(element.data(), key)) {
          ...
          menu += `<tr >
                        ...
                        <td class = "w-40% overflow-hidden"><span class = "statechanger cursor-pointer" metadata = '${attr}'>${availablity}</span></td>
                        <td class = "w-20%">
